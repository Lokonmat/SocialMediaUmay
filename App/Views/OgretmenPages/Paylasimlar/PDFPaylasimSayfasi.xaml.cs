...
namespace App.Views.OgretmenPages.Paylasimlar
{
    ...
    public partial class PDFPaylasimSayfasi : ContentPage
    {
        ...
        private async void PickPDF_Clicked(object sender, EventArgs e)
        {
            try
            {
                ...
                if (result != null)
                {
                    ...
                    pdfNameLabel.Text = $"{result.FileName}";
                    pdfFrame.IsVisible = true;
                }
        ...
        private async void SavePDFButton(object sender, EventArgs e)
        {
            try
            {
                ...
                foreach (var ogrenci in selectedStudents)
                {
                    ...
                    string yeniIcerik = $"{fullName} bir PDF paylaştı.";
                }
